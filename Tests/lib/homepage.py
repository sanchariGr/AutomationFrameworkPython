...
class Homepage(BasePage):
    ...
    def select_category(self):
        ...
        category = self.driver.find_element_by_css_selector\
            ('.nav_a[href="/Laptops/b/ref=sd_allcat_computers_laptop?ie=UTF8&node=1375424031"]')
        category.click()

    def select_category_name(self):
        category_name = self.driver.find_element_by_xpath('//img[@alt="Laptops for business and work"]')
        category_name.click()
